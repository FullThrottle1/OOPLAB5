...
namespace LAB6
{
    public partial class Form1 : Form
    {
        ...
        public bool CheckLocation(int _x, int _y)
        {
            if ((_x - defaultSize / 2 > 0 && _y - defaultSize / 2 > 0) && (_y + defaultSize / 2 < pictureBox1.Height) && (_x + defaultSize / 2 < pictureBox1.Width)) return true;
            else return false;
        }
    }
}